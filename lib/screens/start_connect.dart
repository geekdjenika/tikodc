...
class StartConnect extends StatefulWidget {
  const StartConnect({Key? key}) : super(key: key);

  @override
  State<StartConnect> createState() => _StartConnectState();
}

class _StartConnectState extends State<StartConnect> {
          ...
          child: GestureDetector(
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(top: MediaQuery.of(context).size.height / 6,bottom: 20,right: 20,left: 20),
                  child: SelectionArea(
                      child: RichText(
                          textAlign: TextAlign.center,
                          text: TextSpan(
                            ...
                            SelectionArea(
                                child: GestureDetector(
                                  onTap: () => {
                                    ...
                                    _haveAccount
                                        ? Navigator.push(context, MaterialPageRoute(builder: (context) => const StartPage(haveAccount: false,)),)
                                        : null
                                  },
                                  child: Text(
                                    ' Inscription',
